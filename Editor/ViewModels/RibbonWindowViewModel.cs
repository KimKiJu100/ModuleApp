...
namespace Editor.ViewModels
{
    public class RibbonWindowViewModel : ViewModelBase
    {
        ...
        public RibbonWindowViewModel(IRegionManager regionManager, IApplicationCommands applicationCommands, IDialogService dialogService)
        {
            ...
            _regionManager.RegisterViewWithRegion(RegionNames.RibbonRegion, typeof(DeviceTab));
            _regionManager.RegisterViewWithRegion(RegionNames.RibbonRegion, typeof(MotionTab));
            _regionManager.RegisterViewWithRegion(RegionNames.RibbonRegion, typeof(PLCTab));
        }
